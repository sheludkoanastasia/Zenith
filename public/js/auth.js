document.addEventListener('DOMContentLoaded', () => {
    ...
    function addStyles() {
        if (!document.getElementById('auth-styles')) {
            ...
            style.textContent = `
                ...
                /* Современные сообщения об ошибках */
                .error-toast {
                    position: fixed;
                    top: 100px;
                    right: 30px;
    ...
    // ===============================
    // Функция для показа ошибки валидации поля
    // ===============================
    ...
    if (regEmailInput) {
        regEmailInput.addEventListener('blur', async function() {
            ...
            console.log('Проверка email при потере фокуса:', email);
            
            // Проверяем, что email выглядит валидно
    ...
    if (registerButton) {
        registerButton.addEventListener('click', async function(e) {
            ...
            // =============================================
            // НОВАЯ ВАЛИДАЦИЯ ПАРОЛЯ (вставьте это)
            // =============================================
            function validatePassword(password) {
                const errors = [];
                
                // Проверка на недопустимые символы (эмодзи, русские и т.д.)
                ...
                if (!allowedCharsRegex.test(password)) {
                    ...
                    return errors; // Возвращаем сразу, дальше проверять бессмысленно
                }
            ...
            // Используем функцию для проверки пароля
            ...
            try {
                ...
                // Если email свободен, сохраняем данные и переходим на второй шаг
